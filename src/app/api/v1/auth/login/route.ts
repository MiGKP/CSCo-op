 ...
 * 
 * Allows the external Student Website to authenticate a student using the
 * studentId and random password generated by the instructor, and immediately
 * returns the student's company info to display.
 */
